...
output: 
  prettydoc::html_pretty:
    ...
    fig_caption: yes
vignette: >
  %\VignetteIndexEntry{devrcap package usage}
...
Function and data from **devercap** package would be useful to show
information about history of earthquake arround the world.
